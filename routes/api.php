...
Route::prefix('user')->group(
    function () {
        ...
        Route::post('/update-telephone', [UserController::class, 'updateTelephone'])->name('updateTelephone');
    }
);
...
Route::prefix('property')->group(
    function () {
        ...
        Route::post('/edit-property', [PropertyController::class, 'editProperty'])->name('editProperty');
...
Route::prefix('reels')->group(
    function () {
        ...
        Route::post('/get-user-likes', [ReelsController::class, 'getUserLikes'])->name('getUserLikes');
    }
);
...
Route::prefix('agent')->group(
    function () {
        ...
        Route::post('/get_partner_properties', [AgentController::class, 'getPartnerProperties'])->name('getPartnerProperties');
    }
);
