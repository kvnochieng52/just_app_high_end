                          ...
                          <div class="row">
                              ...
                              <div class="form-group">
                                ...
                                >
                                  <option
                                    v-for="(
                                      actOption, optKey
                                    ) in userActiveOptions"
                                    :key="optKey"
                                    :value="actOption.value"
                                  >
                                    {{ actOption.option }}
                                  </option>
                                </select>
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group">
                                ...
                                >
                                  <option
                                    v-for="(roleOption, roleKey) in roleOptions"
                                    :key="roleKey"
...
let form = useForm({
  ...
  isActive: props.userDetails.is_active,
  role: props.role,
...
let submitForm = () => {
  ...
  form.post("/dashboard/update-user", form, {
    forceFormData: true,
...
let userActiveOptions = ref([
  { option: "Active", value: 1 },
  { option: "Suspend", value: 2 },
]);
