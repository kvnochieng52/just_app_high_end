              ...
              <div class="single-page w-100 p-0">
                <div class="wrapper wrapper2">
                  ...
                  >
                    ...
                    <div class="row" v-if="fetchingSubRegions == 2">
                      <div class="col-md-12">
                    ...
                    <div class="form-group" v-if="fetchingSubRegions == 2">
                      <input
                        type="text"
                        name="propertyTitle"
...
export default {
  ...
  components: { Select2, Head, FilePond, VueMultiImageUpload },
  data() {
    return {
      component: {},
      inputImages: [],
